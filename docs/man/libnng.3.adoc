...
|xref:nng_mqtt_subscribe_async.3.adoc[nng_mqtt_subscribe_unasync()]|perform a subscribe request asynchnously
|xref:nng_mqtt_unsubscribe.3.adoc[nng_mqtt_subscribe()]|perform a subscribe request synchnously
|xref:nng_mqtt_unsubscribe_async.3.adoc[nng_mqtt_subscribe_unasync()]|perform a subscribe request asynchnously

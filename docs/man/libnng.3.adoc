...
The library support MQTT V3.1.1/5.0
...
|xref:nng_mqtt_subscribe.3.adoc[nng_mqtt_subscribe()]|perform a subscribe request synchnously
|xref:nng_mqtt_subscribe_async.3.adoc[nng_mqtt_subscribe_async()]|perform a subscribe request asynchnously
|xref:nng_mqtt_unsubscribe.3.adoc[nng_mqtt_unsubscribe()]|perform a subscribe request synchnously
|xref:nng_mqtt_unsubscribe_async.3.adoc[nng_mqtt_unsubscribe_async()]|perform a subscribe request asynchnously

...
function(nng_link_libraries)
    ...
    if (DEBUG)
        if (ASAN)
            target_link_libraries(nng_testing PRIVATE ${ARGN} -g -fsanitize=address)
        elseif (TSAN)
            target_link_libraries(nng_testing PRIVATE ${ARGN} -g -fsanitize=thread)
        endif (ASAN)
    else()
        target_link_libraries(nng_testing PRIVATE ${ARGN} -g)
    endif (DEBUG)
endfunction()
